  ...
  return (
    <div className="flex flex-col overflow-hidden rounded-lg mx-6 shadow-lg  hover:animate-hoverCard border-2 hover:cursor-pointer">
      ...
      <div className="px-2 py-2 flex flex-col justify-between">
        <div className=" text-lg font-bold whitespace-nowrap overflow-hidden text-ellipsis">{props.name}</div>
        <div className="text-gray-500  text-base mt-2 whitespace-nowrap overflow-hidden text-ellipsis">{props.author}</div>
